...
The planning page now includes a guided cycle-creation wizard to help you move from goals to executable weeks.

You can:

- Set macro-cycle start date and define one or more goals/events
...
1. Open the cycle creation section on the planning surface.
...
This is a web v1 planning feature. Mobile workout execution is out of scope here.
